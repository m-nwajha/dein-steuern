export const PATHS = {
    ...
    services: '#',
    kooperation: '#',
    buchfuhrung: '/services/buchfuehrung',
    firmenberatung: '/services/firmenberatung',
    lohneUndGehalter: '/services/loehne-und-gehaelter',
    uberUns: '/ueber-uns',
    kontakt: '/kontakt',
    umsatzsteuer: '/services/umsatzsteuer',
    einkommensteuer: '/services/einkommensteuer',
    gewerbesteuer: '/services/gewerbesteuer',
    korperschaftssteuer: '/services/koerperschaftssteuer',
    impressum: '/impressum',
