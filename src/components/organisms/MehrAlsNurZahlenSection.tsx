            ...
            <Container variant='xl'>
                <Grid sm={1} md={1} lg={2} gap={6}>
                    <Box display='flex' direction='col' gap={2} justifyContent='center' className='order-1 lg:order-2'>
                        ...
                        <Button variant='solid' as='link' href={MEHR_ALS_NUR_ZAHLEN.button.href} icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ml-1" viewBox="0 0 16 16">
